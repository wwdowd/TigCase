...
//tig_cycle.csv file on SD card has 2 columns w/ pH,DO setpoints every 1 min NO HEADER ROW
//ensure .csv file is saved with values as number format and set number of decimals in Excel first
...
float Salinity, value; //this will be our daily input of S values
