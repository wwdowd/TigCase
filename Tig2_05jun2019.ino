...
static double getpH () {
   ...
   pHtemp = (pHRaw+1)*188.0/1000/pHresist;  //187.5 nominally
   pHVolt = (pHtemp+2)/2; // use slope of mA output vs pH (3-20mA for pH 3-11)
...
//  Serial.println(DORaw+1);
  DOtemp = (DORaw+1)*188.0/1000/DOresist;  // = I in Ohm's law equation
